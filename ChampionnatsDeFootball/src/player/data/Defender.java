 ...
 * @author isoyturk
 */
//Point 1: creation d'objet Defender avec getteurs et setteurs
//Point 8: Héritage, cette classe hérite de Player.java
//Point 3 : utilisation de l'interface PlayerActions
public class Defender extends Player implements PlayerActions {
     ...
     * @param bestAssister
     */
    //Point 6:Utilisation du constructeur de Player dans la classe fille Defender
    public Defender(int idPlayer, String name, int myClubId, String nationality, String position, int average, int age, int assists, int goals, boolean bestScorer, boolean bestAssister) {
